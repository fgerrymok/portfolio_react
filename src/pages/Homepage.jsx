...
import loadingAnimation from "../assets/videos/loading_animation.webm";
...
function Homepage() {
    ...
    const email = "fgerrymok@gmail.com"; // change to an ACF field later
    ...
    useEffect(() => {
        async function fetchHomepageData() {
            ...
            if ( response.ok ) {
                ...
                setTimeout(handlePageContents, 2000);
            }
        }
        fetchHomepageData();
    }, [homepagePath])

    function handlePageContents() {
    ...
    return (
        ...
        {homepageLoaded ? 
            <div className={menuActive ? "main-pushed-left" : "main"} onClick={() => {menuActive ? toggleNav(menuActive, setMenuActive) : null}}>
                <div className={contentLoaded ? "hide-loading-animation" : "show-loading-animation"}>
